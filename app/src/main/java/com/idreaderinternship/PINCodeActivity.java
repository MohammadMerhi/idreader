...
public class PINCodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityName = mIntent.getStringExtra("activityName");
    ...
    public void waitToGoOrNo() {
        if (position == 4 && checkPinCode(pinCodeInput) == true && activityName == null) {
            try {
                Thread.sleep(200);
            ...
            finish();
        } else if (position == 4 && checkPinCode(pinCodeInput) == true && activityName != null) {

            if (activityName.equals("ScanID")) {
                Intent goTo = new Intent(this, ScanID.class);
                startActivity(goTo);
                finish();
            } else if (activityName.equals("ChangePINCode")) {
                Intent goTo = new Intent(this, ChangePINCode.class);
                startActivity(goTo);
                finish();
            } else if (activityName.equals("ManualEntry")) {
                Intent goTo = new Intent(this, ManualEntry.class);
                startActivity(goTo);
                finish();
            } else if (activityName.equals("Settings")) {
                Intent goTo = new Intent(this, Settings.class);
                startActivity(goTo);
                finish();
                ...
                startActivity(goTo);
                finish();
            } else if (activityName.equals("ManualEntryCheckOut")) {
                Intent goTo = new Intent(this, ManualEntryCheckOut.class);
                startActivity(goTo);
                finish();
            }
